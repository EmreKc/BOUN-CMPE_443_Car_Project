...
//Correctly define TIMER_TypeDef struct.
typedef struct {
...
#define IOCON_OUT_ADDRESS	0x4002C05C
#define IOCON_OUT	*((volatile uint32_t*)(IOCON_OUT_ADDRESS))
	
extern uint32_t currentTime;
extern uint32_t previousTime;
extern uint32_t capturedTime;
extern uint32_t leftPressed;
extern uint32_t rightPressed;
