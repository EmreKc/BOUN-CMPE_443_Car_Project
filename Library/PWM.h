...
#define IOCON_MOTOR_SPEED_ADDRESS2	0x4002C088
#define IOCON_MOTOR_SPEED_RIGHT	*((volatile uint32_t*)(IOCON_MOTOR_SPEED_ADDRESS2))
//#define IOCON_P7_ADDRESS 0x4002C074
//#define IOCON_P7 *((volatile uint32_t*)(IOCON_P7_ADDRESS))
...
void PWM_Write_Right(uint32_t T_ON) ;
